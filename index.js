const CHAT_BUTTON_WIDTH = 180; // width of the chat button in pixels
...
const CHAT_BUTTON_BORDER_RADIUS = '25px'; // radius of the chat button in pixels
...
chatButton.innerHTML = "Chat with us!"; // Add a label next to the icon
...
chat.style.display = 'none';
chat.style.borderRadius = '15px'; // Increased border radius for better aesthetics
chat.style.zIndex = 999999999;
chat.style.overflow = 'hidden';
chat.style.background = 'linear-gradient(160deg, #0093E9 0%, #80D0C7 100%)'; // Add a gradient for visual appeal
